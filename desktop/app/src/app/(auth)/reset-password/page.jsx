...
export default function ResetPasswordPage() {
  ...
  if (token === "") {
    return (
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold text-fg">Invalid reset link</h2>
        <p className="text-fg-muted mt-2">
          This link is missing its reset token. Please request a new one.
        </p>
        <Link
          href="/forgot-password"
          className="inline-block text-sm font-semibold text-brand hover:text-brand-700 mt-6"
        >
          Request a new link
        </Link>
      </div>
  ...
  if (done) {
    return (
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold text-fg">Password reset</h2>
        <p className="text-fg-muted mt-2">
  ...
  return (
    <div>
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-fg">Set a new password</h2>
        <p className="text-fg-muted mt-1">Choose a new password for your account.</p>
      </div>
