...
// Desktop launch screen. The web build opens on a marketing landing page; an
// installed app has already been "sold", so this is a short branded intro that
// hands straight over to sign-in — or to the workspace if a session survived.
//
// It also buys cover for auth hydration: AuthContext reads storage and
